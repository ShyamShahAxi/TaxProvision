...
| **Medical** | Insurance premium breakdown (attach CSV), split **Life** (non-deductible) vs **Medical**. Medical-expense capping: deductible medical limited to a % (1%, or 2% portable) of employee remuneration; the excess and life premiums feed Current Tax as computed permanent add-backs |
